...
window.onload = function() {
    ...
    var terrainImageLoaded = false,
     ...
     item1ImageLoaded = false,
     item2ImageLoaded = false,
     item3ImageLoaded = false,
    ...
    playerImage.onload = function() {
        ...
        item1ImageLoaded = true;
        // item2ImageLoaded = true;
      assetsLoaded();
    };
    ...
    enemy2Image.src = "/img/enemy-1.png";
    ...
    player.move = function(direction) {
      ...
      if (player.x == enemy2.x && player.y == enemy2.y && score < 3 ) {
      ...
      } else if (player.x == enemy2.x && player.y == enemy2.y && score == 3) {
        // found a enemy2 !! create a new one
        console.log('find enemy ');
        // pokePick.pause();
        // pokePick.currentTime = 0;
    ...
    //   ctx.fillText('You skill', w - 93, h - 45);
  
    //   ctx.font = '14px Arial';
    //   ctx.fillStyle = 'rgba(255, 255, 255, 1)';
    //   ctx.fillText(score + ' enemy', w - 85, h - 25);
